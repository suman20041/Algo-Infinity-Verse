...
(function () {
  ...
  function handleCopyClick(e) {
    var btn = e.target.closest('.c-code-copy');
    if (!btn) return;
    var code = btn.getAttribute('data-code');

    if (!code) {
      var pre = btn.closest('.c-code-block').querySelector('pre');
      if (pre) {
  ...
  function handleExerciseToggle(e) {
    var btn = e.target.closest('.c-exercise-toggle');
    if (!btn) return;
  ...
  function initTopicNav() {
    var pills = document.querySelectorAll('.c-topic-pill');
    var lessons = document.querySelectorAll('.c-lesson');
  ...
  function updateProgressDots(topicIndex) {
    var dots = document.querySelectorAll('.c-progress-dot');
    var lines = document.querySelectorAll('.c-progress-line');
  ...
  document.addEventListener('click', function (e) {
    var copyBtn = e.target.closest('.c-code-copy');
    if (copyBtn) {
      handleCopyClick(e);
      return;
    }

    var toggleBtn = e.target.closest('.c-exercise-toggle');
    if (toggleBtn) {

...
(function () {
  ...
  function initCopyButtons() {
    document.querySelectorAll('.cs-code-copy').forEach(function (btn) {
  ...
  function handleCopyClick(e) {
    var btn = e.currentTarget.classList.contains('cs-code-copy')
      ? e.currentTarget
      : e.target.closest('.cs-code-copy');
    if (!btn) return;
    var code = btn.getAttribute('data-code');

    if (!code) {
      var pre = btn.closest('.cs-code-block').querySelector('pre');
      if (pre) {
  ...
  function initExerciseToggles() {
    document.querySelectorAll('.cs-exercise-toggle').forEach(function (btn) {
  ...
  function handleExerciseToggle(e) {
    var btn = e.currentTarget.classList.contains('cs-exercise-toggle')
      ? e.currentTarget
      : e.target.closest('.cs-exercise-toggle');
    if (!btn) return;
  ...
  function initTopicNav() {
    var pills = document.querySelectorAll('.cs-topic-pill');
    var lessons = document.querySelectorAll('.cs-lesson');
  ...
  function updateProgressDots(topicIndex) {
    ...
    var lines = document.querySelectorAll('.cs-progress-line');
  ...
  document.addEventListener('click', function (e) {
    var copyBtn = e.target.closest('.cs-code-copy');
    if (copyBtn) {
      handleCopyClick(e);
      return;
    }

    var toggleBtn = e.target.closest('.cs-exercise-toggle');
    if (toggleBtn) {

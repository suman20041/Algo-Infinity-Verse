/* ================================================
   JAVA LEARNING PAGE — Interactive Functions
   ================================================
...
(function () {
  ...
  /* --------------------------------------------
     CONSTANTS
     -------------------------------------------- */
  const PROGRESS_KEY = 'jv_progress';
  ...
  function initCopyButtons() {
    document.querySelectorAll('.jv-code-copy').forEach(function (btn) {
  ...
  function handleCopyClick(e) {
    var btn = e.currentTarget.classList.contains('jv-code-copy') ? e.currentTarget : e.target.closest('.jv-code-copy');
    if (!btn) return;
    var code = btn.getAttribute('data-code');

    if (!code) {
      var pre = btn.closest('.jv-code-block').querySelector('pre');
      if (pre) {
  ...
  function initExerciseToggles() {
    document.querySelectorAll('.jv-exercise-toggle').forEach(function (btn) {
  ...
  function handleExerciseToggle(e) {
    var btn = e.currentTarget.classList.contains('jv-exercise-toggle') ? e.currentTarget : e.target.closest('.jv-exercise-toggle');
    if (!btn) return;
  ...
  function initTopicNav() {
    var pills = document.querySelectorAll('.jv-topic-pill');
    var lessons = document.querySelectorAll('.jv-lesson');
  ...
  function updateProgressDots(topicIndex) {
    var dots = document.querySelectorAll('.jv-progress-dot');
    var lines = document.querySelectorAll('.jv-progress-line');
  ...
  document.addEventListener('click', function (e) {
    var copyBtn = e.target.closest('.jv-code-copy');
    if (copyBtn) {
      handleCopyClick(e);
      return;
    }

    var toggleBtn = e.target.closest('.jv-exercise-toggle');
    if (toggleBtn) {

/* ================================================
   RUBY LEARNING PAGE -- Interactive Functions
   ================================================
...
(function () {
  ...
  function handleCopyClick(e) {
    var btn = e.target.closest('.rb-code-copy');
    if (!btn) return;
    var code = btn.getAttribute('data-code');

    if (!code) {
      var pre = btn.closest('.rb-code-block').querySelector('pre');
      if (pre) {
  ...
  function handleExerciseToggle(e) {
    var btn = e.target.closest('.rb-exercise-toggle');
    if (!btn) return;
  ...
  function initTopicNav() {
    var pills = document.querySelectorAll('.rb-topic-pill');
    var lessons = document.querySelectorAll('.rb-lesson');
  ...
  function updateProgressDots(topicIndex) {
    var dots = document.querySelectorAll('.rb-progress-dot');
    var lines = document.querySelectorAll('.rb-progress-line');
  ...
  document.addEventListener('click', function (e) {
    if (e.target.closest('.rb-code-copy')) {
      handleCopyClick(e);
      return;
    }

    if (e.target.closest('.rb-exercise-toggle')) {
